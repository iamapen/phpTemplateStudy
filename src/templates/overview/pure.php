<?php
/**
 * @var \Poppy\TemplateStudy\PurePhp\View $this
 */
use Poppy\TemplateStudy\Def;
?>
<?php $this->setLayoutVar('title', '基本')?>
...
<dl>
  ...
  <dt>htmlEscape</dt><dd><?=htmlspecialchars($htmlString, ENT_QUOTES)?></dd>
...
<h1>include</h1>
<?=$this->include(__DIR__ . '/include/list.php', ['list'=>$arr2])?>
